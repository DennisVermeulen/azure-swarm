...
if (-not $restart) {
    ...
    [DownloadWithRetry]::DoDownloadWithRetry("https://raw.githubusercontent.com/DennisVermeulen/azure-swarm/$branch/configs/sshd_config_wopwd", 5, 10, $null, 'C:\ProgramData\ssh\sshd_config', $false)
